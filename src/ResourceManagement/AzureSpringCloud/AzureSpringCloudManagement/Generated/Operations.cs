...
namespace Microsoft.AppPlatform
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AppPlatformManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AppPlatformManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationDetail>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.AppPlatform/operations").ToString();
